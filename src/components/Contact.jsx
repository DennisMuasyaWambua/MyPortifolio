...
const Contact = () => {
  ...
  const handleSubmit = (e)=>{
    ...
    emailjs.send(
      'service_8e631my', 
      'template_ufs2jbj',
      {from_name: form.name, to_name: 'dennis', from_email:form.email, to_email: 'muasyathegreat4@gmail.com', message:form.message},
      'a-UTv7kM1bG2kJel-').then(()=>{
        setLoading(false);
              ...
              >
                ...
                <label className="flex flex-col">
                  ...
                  <textarea rows="7" className='bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outlined-none border-none font-medium'
                   type="text" name="message" value={form.message} onChange={handleChange} placeholder="What do you want to say" />
                </label>
